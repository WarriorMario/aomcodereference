 ...
 */
public class TrainPlan extends Plan{
	private TrainPlan () {}

	/** The ID value of the train plan. */
	public final int cPlanTrain=3;
	/** The Building Type ID to train from.
	 * @autocreated */
	public final int cTrainPlanBuildingID=0;
	/** The army to put the trained units in.
	 * @autocreated */
	public final int cTrainPlanIntoArmyID=1;
	/** The plan to put the trained units in.
	 * @autocreated */
	public final int cTrainPlanIntoPlanID=2;
	/** The base to put the trained units in.
	 * @autocreated */
	public final int cTrainPlanIntoBaseID=3;
	/** The number of units to train.
	 * @autocreated */
	public final int cTrainPlanNumberToTrain=4; 
	/** The number of units to maintain.
	 * @autocreated */
	public final int cTrainPlanNumberToMaintain=5;
	/** The number of units trained by the plan.
	 * @readonly @autocreated */
	public final int cTrainPlanNumberTrained=6;
	/** The unit type of the unit to train (not sure if this can be multiple).
	 * @autocreated */
	public final int cTrainPlanUnitType=7;
	/** The building type the plan trains units from.
	 * @autocreated */ 
	public final int cTrainPlanBuildFromType=8;
	/** The IDs of the trained units.
	 * @readonly @autocreated*/
	public final int cTrainPlanTrainedUnitID=9;
	/** The frequency the plan checks to train units?
	 * @autocreated */ 
	public final int cTrainPlanFrequency=10;
	/** When set to 1 it allows the plan to use multiple buildings.
	 * @autocreated */ 
	public final int cTrainPlanUseMultipleBuildings=11;
	/** The gatherpoint to send the trained units to.
	 * @autocreated */ 
	public final int cTrainPlanGatherPoint=12;
	/** The unit the units are tasked on when trained.
	 * @autocreated */ 
	public final int cTrainPlanGatherTargetID=13;
	/** The base to maintain the given number of units in?
	 * @autocreated */ 
	public final int cTrainPlanMaintainBaseID=14;
	/** The area to maintain the given number of units in?
	 * @autocreated */ 
	public final int cTrainPlanMaintainAreaID=15;
	/*
